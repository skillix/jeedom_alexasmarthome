...
//	$('#md_modal').load('index.php?v=d&plugin=alexaamazonmusic&modal=history&id=alexaamazonmusic&size='+selectedSize).dialog('open');
	$('#md_modal').load('index.php?v=d&plugin=alexaamazonmusic&modal=history&id=alexaamazonmusic').dialog('open');
});
</script>

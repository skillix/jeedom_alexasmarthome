...
include_file('desktop', 'jsonviewer', 'php', 'alexaamazonmusic');
...
echo  '<a class="btn btn-success pull-right" target="autre" href="http://'.config::byKey('internalAddr') . '/plugins/alexaamazonmusic/resources/data/'.$partieFichier.'"><i class="fa fa-upload"></i> Télécharger JSON</a>';
...
//window.alert(selectedDevice+"-"+selectedJSON);
	...
	$('#md_modal').load('index.php?v=d&plugin=alexaamazonmusic&modal=req&id=alexaamazonmusic&json='+selectedJSON+'&device='+selectedDevice).dialog('open');

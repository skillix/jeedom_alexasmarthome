...
return $dR.$dG.$dB;
	...
	public function postSave() {
		...
		if(!empty($capa)) {
			...
			self::updateCmd ($F, 'temperature-set', 'action', 'select', false, 'Définir Température du blanc', false, true, null, null, null, 'SmarthomeCommand?command=setColorTemperature&color=#select#', "refresh", 'warm_white|warm_white;soft_white|soft_white;white|white;daylight_white|daylight_white;cool_white|cool_white', 16, $cas6);
